...
#程序无法运行：webdriver.PhantomJS执行execute_script报错，json.loads()格式不对。没有解决
...
class spider_wechat:
    ...
    def get_selenium_js_html(self):
        ...
        '''
        #for i in range(3):
        tags1 = BeautifulSoup(html,'html.parser').find('div',id='js_nomore')
        if tags1:
